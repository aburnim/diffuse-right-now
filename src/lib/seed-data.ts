...
export const seedData: AppState = {
  ...
  team: [
    ...
    {
      id: "evt-1",
      title: "Sampleworks Bi-weekly Technical Discussion",
      date: "2026-04-06",
      type: "meeting",
      workstreamId: "sampleworks",
      description: "Technical deepdive, bi-weekly cadence. Attendees: Marcus Collins, Karson Chrispens, Stephanie Wankowicz",
    },
    {
      id: "evt-2",
      title: "Water Check In Meeting",
      date: "2026-04-06",
      type: "meeting",
      workstreamId: "water-modeling",
      description: "Bi-weekly water modeling WG check-in. Attendees: Marcus Collins, Stephanie Wankowicz, Doris Mai, Vratin Srivastava, Huanghao Mai",
    },
    {
      id: "evt-3",
      title: "DiffUSE Sample and Data Processing Working Group",
      date: "2026-04-07",
      type: "meeting",
      workstreamId: "sampleworks",
      description: "Cross-institutional WG on sample and data processing. Attendees include Justin Biel, Kara Zielinski, James Holton, Artem Lyubimov, Stephanie Wankowicz, and others",
    },
    {
      id: "evt-4",
      title: "Justin-Stephanie Encoding",
      date: "2026-04-09",
      type: "meeting",
      workstreamId: "encoding",
      description: "Bi-weekly Encoding workstream sync. Attendees: Justin Biel, Stephanie Wankowicz",
    },
    {
      id: "evt-5",
      title: "DiffUSE / Ptown Weekly Engineering Sync",
      date: "2026-04-09",
      type: "meeting",
      workstreamId: "infrastructure",
      description: "Weekly engineering standup focused on decisions, user feedback, and prioritization. Attendees: Justin Biel, Joseph Lee, Abdelsalam Naeim, Abbas, Moody, Sebin, Michael Anzuoni, and others",
    },
    {
      id: "evt-6",
      title: "Sampleworks Bi-weekly Planning Check-in",
      date: "2026-04-13",
      type: "meeting",
      workstreamId: "sampleworks",
      description: "Planning-focused Sampleworks meeting (alternates with technical discussion). Attendees: Marcus Collins, Jaime Fraser, Stephanie Wankowicz, Karson Chrispens",
    },
    {
      id: "evt-7",
      title: "DiffUSE / Ptown Weekly Engineering Sync",
    ...
    {
      id: "evt-8",
      title: "DiffUSE Spring All Hands: Virtual",
      date: "2026-05-06",
      type: "milestone",
      description: "Deep dive on data collection and processing. 26 attendees. Followed by Business Meeting / debrief (6:00-7:00 PM ET)",
    },
    {
      id: "evt-9",
      title: "DiffUSE Summer All Hands: Virtual",
      date: "2026-07-23",
      type: "milestone",
      description: "Deep dive on modeling and encoding. 26 attendees. Followed by Business Meeting / debrief (6:00-7:00 PM ET)",
    },
    {
      id: "evt-10",
      title: "DiffUSE Fall Retreat (In-Person)",
      date: "2026-10-08",
      type: "milestone",
      description: "Two-day in-person retreat at Astera Institute, Emeryville. Oct 8-9, 9 AM - 5 PM PT. 30 attendees. Includes EAC invitation session.",
    },
  ],
